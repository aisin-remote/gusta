...
@section('content')
    <div class="row">
        <div class="col-lg-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Create Ticket <small class="text-muted pl-0">/ Buat Tiket / チケットを作る</small>
                    </h4>
                    <form action="{{ route('appointment.create') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label for="inputEmail3" class="col-form-label">Visit Purpose <small
                                        class="text-muted pl-0">/ Tujuan Kunjungan / 滞在目的</small></label></label>
                            </div>
                            <div class="col-md-8">
                                <div class="boxes">
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label for="inputEmail3" class="col-form-label">Select Room <small class="text-muted pl-0">/
                                        Pilih Ruangan / 部屋を選択</small></label>
                            </div>
                            <div class="col-md-8">
